  ...
  return (
    <div className="mb-5 bg-amber-50 border border-amber-200 rounded-xl p-5">
      <div className="flex items-start justify-between mb-3">
        <p className="text-sm font-bold text-amber-800">Welcome to Peak Mode 👋</p>
        <button
          onClick={handleDismiss}
          className="text-amber-400 hover:text-amber-600 text-xs ml-3 shrink-0 transition-colors"
          aria-label="Dismiss onboarding"
        >
          ✕
        </button>
      </div>
      <p className="text-xs text-amber-700 mb-4">Get started in 3 simple steps:</p>
      ...
      <div className="flex items-center gap-3">
        <Link
          to="/arena/career"
          className="text-xs font-semibold text-white bg-amber-500 hover:bg-amber-600 px-4 py-2 rounded-lg transition-colors"
        >
          Set up Career tasks →
        </Link>
        <button
